...
module Crystal
   ...
   class OnyxParser < OnyxLexer
      ...
      def parse_expression
         ...
         can_be_def = possible_def_context && (
            kwd?(:def, :fn, :fun, :own, :me, :func, :meth, :pure, :proc) ||
...
#
      ...
      def parse_idfr_type_new_call_sugar(idfr)
         ...
         if arg_node
            ...
            return tag_onyx Call.new(idfr, "new", args, block, explicit_block_param, named_args, false, 0, has_parens)
      ...
      def parse_intype_def_var_or_const(on_self = false) : Array(ASTNode)
         ...
         when tok?(:CLASS_VAR) || tok?(:INSTANCE_VAR) || tok?(:IDFR)
            ...
            if var_type
               ...
               rets << DeclareVar.new(var, var_type, is_assign_composite).at(var.location)
            end
      ...
      def parse_var_or_call(global = false, force_call = false)
         ...
         node =
            if block || explicit_block_param || global
               ...
               tag_onyx Call.new instance, name, (args || [] of ASTNode), block, explicit_block_param, named_args, global, name_column_number, has_parens
            else
               if args
                  ...
                  if (!force_call && is_var) && args.size == 1 && (num = args[0]) && (num.is_a?(NumberLiteral) && num.has_sign?)
                     ...
                     tag_onyx Call.new(instance, name, args, nil, explicit_block_param, named_args, global, name_column_number, has_parens)
                  end
               else
                  ...
                  if tok?   :"'", :"~", :"^" # , :":" # :"::"   - *TODO*, if ':' is wished to be used for this - either block-: or something else has to be ditched
                     ...
                     tag_onyx Call.new instance, name, [] of ASTNode, nil, explicit_block_param, named_args, global, name_column_number, has_parens
                  end
               end
            end
